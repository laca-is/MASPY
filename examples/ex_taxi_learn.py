...
class Taxi(Environment):
    def __init__(self, env_name) -> None:
        ...
        # self.create(Percept("Continuous Values from -1 to 1 both included", [-1,1], group="interval"))
        # self.create(Percept("Discrete Values from 2 to 11 both included", [2,11], group="sequence"))
        # self.create(Percept("Product of values - 5x10x...x3", (5,10,...,3), group="combination"))
...
if __name__ == "__main__":
    ...
    ag = Sample("Ag")
    ag.add(Goal("aquire_learning",[model]))
    Admin().start_system()